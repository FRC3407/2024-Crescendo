...
public class Flinger extends SubsystemBase {
    ...
    private SparkMax flingerMotor_1; // here, change names
    private SparkMax flingerMotor_2; 
    ...
    public Flinger() {
        flingerMotor_1 = new SparkMax(Constants.FlingerConstants.flingerCanID_1, MotorType.kBrushless);
        flingerMotor_1.setInverted(true);

        flingerMotor_2 = new SparkMax(Constants.FlingerConstants.flingerCanID_2, MotorType.kBrushless);
