...
public class DriveCommand extends Command {
  ...
  public DriveCommand(DriveSubsystem subsystem, DoubleSupplier m_linearXSupplier, DoubleSupplier m_linearYSupplier, DoubleSupplier m_angularSpeedSupplier, BooleanSupplier m_linearBoostSupplier, BooleanSupplier m_linearBoostSupplier2, BooleanSupplier m_setXSupplier, BooleanSupplier m_zeroHeadingSupplier) {
  ...
  public DriveCommand(DriveSubsystem subsystem, DoubleSupplier m_linearXSupplier, DoubleSupplier m_linearYSupplier, DoubleSupplier m_angularSpeedSupplier, DoubleSupplier m_linearBoostSupplier, DoubleSupplier m_linearBoostSupplier2, BooleanSupplier m_setXSupplier, BooleanSupplier m_zeroHeadingSupplier) {
    this.m_driveSubsystem = subsystem;
    this.m_linearXSupplier = m_linearXSupplier;
    this.m_linearYSupplier = m_linearYSupplier;
    this.m_angularSpeedSupplier = m_angularSpeedSupplier;
  ...
  public void execute() {
    m_driveSubsystem.drive(
      -MathUtil.applyDeadband(m_linearYSupplier.getAsDouble()/2.25*(m_linearBoostSupplier.getAsBoolean()==true?1.5:1)
      *(m_linearBoostSupplier2.getAsBoolean()==true?1.5:1)
      *(m_linearBoostSupplier.getAsBoolean()==true?1.5:1), OIConstants.kDriveDeadband),
      -MathUtil.applyDeadband(m_linearXSupplier.getAsDouble()/2.25*(m_linearBoostSupplier.getAsBoolean()==true?1.5:1)
      *(m_linearBoostSupplier2.getAsBoolean()==true?1.5:1)
      *(m_linearBoostSupplier.getAsBoolean()==true?1.5:1), OIConstants.kDriveDeadband),
